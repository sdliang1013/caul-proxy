...
class YhopProxy(Tcp):
    ...
    def handle(self):
        ...
        assert VER == SOCKS_VERSION, f'SOCKS版本错误: {VER}'
        ...
        assert version == SOCKS_VERSION, f'socks版本错误: {version}'
        ...
        try:
            ...
            print(err)
            # 响应拒绝连接的错误
            reply = self.reply_faild(address_type, 5)
    ...
    def reply_faild(self, address_type, error_number):
        """
        生成连接失败的回复包
        """
